...
public class Myau {
    public static final String DISPLAY_NAME = "Heliosis";
    public static final String CONFIG_DIR = "./config/Heliosis/";
    public static final String LEGACY_CONFIG_DIR = "./config/Myau/";
    public static final String LEGACY_OPENMYAU_CONFIG_DIR = "./config/OpenMyau-plus/";
    public static String clientName = "&7[&bHeliosis&7]&r ";
    ...
    public static String getDisplayTitle() {
        ...
        return DISPLAY_NAME + " (Main) - " + versionText + " | MC " + MC_VERSION;
    }
