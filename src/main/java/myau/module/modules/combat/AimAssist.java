...
@ModuleInfo(name = "AimAssist", enabled = "false", hidden = "false", description = "Assists your aim by subtly adjusting your view towards nearby targets when attacking.", category = Category.COMBAT)
