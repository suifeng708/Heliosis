...
@ModuleInfo(name = "HitBox", enabled = "false", hidden = "false", description = "Expands the hitbox of entities, making them easier to hit. Also has an option to render the expanded hitboxes.", category = Category.COMBAT)
