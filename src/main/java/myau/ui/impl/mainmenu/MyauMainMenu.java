...
public class MyauMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void renderSkybox(int mouseX, int mouseY, float partialTicks)
    {
        ...
        float scale = 120.0F / (float)(this.width > this.height ? this.width : this.height);
        float texHeight = (float)this.height * scale / 256.0F;
        float texWidth = (float)this.width * scale / 256.0F;
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        worldrenderer.pos(0.0D, this.height, this.zLevel).tex(0.5F - texHeight, 0.5F + texWidth).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        worldrenderer.pos(this.width, this.height, this.zLevel).tex(0.5F - texHeight, 0.5F - texWidth).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        worldrenderer.pos(this.width, 0.0D, this.zLevel).tex(0.5F + texHeight, 0.5F - texWidth).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        worldrenderer.pos(0.0D, 0.0D, this.zLevel).tex(0.5F + texHeight, 0.5F + texWidth).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        tessellator.draw();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontProcess.getScaledFont("sans", 3.0f).drawCenteredString(myau.Myau.DISPLAY_NAME, this.width / 2, 35, -1);
